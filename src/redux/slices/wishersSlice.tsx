...
import { addApi, deleteApi, getApi, showApi, updateApi } from '@/redux/api/wishersApi';
...
const wishersSlice = createSlice({
  name: 'wishers',
  initialState: {
    wishers: [] as Data[],
    wisher: {} as Data,
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(add.fulfilled, (state, action) => {
        ...
        state.wishers.push(action.payload.data);
      })
      ...
      .addCase(get.fulfilled, (state, action) => {
        state.isLoading = false;
        state.wishers = action.payload?.data || [];
      ...
      .addCase(update.fulfilled, (state, action) => {
        state.isLoading = false;
        state.wishers = state.wishers.map((wisher) =>
          wisher.id === action.payload.data.id
            ? {
              ...action.payload.data,
      ...
      .addCase(deleteData.fulfilled, (state, action) => {
        state.isLoading = false;
        state.wishers = state.wishers.filter(wisher => wisher.id !== action.payload);
...
export default wishersSlice.reducer;
