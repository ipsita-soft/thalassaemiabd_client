...
import { addApi, deleteApi, getApi, showApi, updateApi } from '@/redux/api/pagesApi';
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(add.fulfilled, (state, action) => {
        ...
        state.tifPages.push(action.payload.data);
      })
      ...
      .addCase(get.fulfilled, (state, action) => {
        state.isLoading = false;
        state.tifPages = action.payload?.data || [];
      ...
      .addCase(update.fulfilled, (state, action) => {
        state.isLoading = false;
        state.tifPages = state.tifPages.map((tifPage) =>
          tifPage.id === action.payload.data.id
            ? {
              ...action.payload.data,
      ...
      .addCase(show.fulfilled, (state, action) => {
        state.tifPage = action.payload.data;
        state.isLoading = false;
      })
      ...
      .addCase(deleteData.fulfilled, (state, action) => {
        state.isLoading = false;
        state.tifPages = state.tifPages.filter(tifPage => tifPage.id !== action.payload);
