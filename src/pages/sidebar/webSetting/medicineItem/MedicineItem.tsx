...
import { useFetchMedicineItemsQuery } from "@/api/medicineItemApi";
import {
    SortingState,
    ColumnFiltersState,
    VisibilityState,
...
import Add from "@/pages/sidebar/webSetting/medicineItem/Add";
import Edit from "@/pages/sidebar/webSetting/medicineItem/Edit";
import Delete from "@/pages/sidebar/webSetting/medicineItem/Delete";
...
export function MedicineItem() {
    ...
    const { data, isLoading, error } = useFetchMedicineItemsQuery({
        perPage,
        search,
        page: currentPage,
    });
