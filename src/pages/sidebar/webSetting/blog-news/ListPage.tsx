...
import { get } from "@/redux/slices/blogNewsSlice";
...
export function ListPage() {
    ...
    const { blogNews, meta, isLoading, isError, error } = useSelector(
        (state: RootState) => state.blogNews
    );
    ...
    const columns = [
        ...
        },
        {
            id: "image",
            header: "Image",
            cell: ({ row }: { row: { original: BlogNews } }) => (
                <img
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <EditModal
                                ...
                                BlogNewsId={blogNews.id.toString()}
                                open={isEditModalOpen}
                                onClose={() => setEditModalOpen(false)}
                            />
                            <br />
                            <Show
                                Id={blogNews.id.toString()}
    ...
    const table = useReactTable({
        data: blogNews as unknown as BlogNews[],
        columns,
        state: {
            sorting,
            columnFilters,
