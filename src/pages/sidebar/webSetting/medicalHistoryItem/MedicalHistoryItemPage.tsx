...
import Add from "@/pages/sidebar/webSetting/medicalHistoryItem/Add";
...
export function MedicalHistoryItemPage() {
    ...
    const columns = [
        ...
        {
            id: "medical_history",
            header: "Medical History Name",
            cell: ({ row }: { row: { original: any } }) => (
                <div className="text-left">{row.original.medical_history.title}</div>
            ),
        },
