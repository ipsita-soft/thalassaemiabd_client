...
import { get } from "@/redux/slices/wishersSlice";
...
export function WishersPage() {
    const dispatch: AppDispatch = useDispatch();
    const { wishers, meta, isLoading, isError, error } = useSelector(
        (state: RootState) => state.wishers
    );
    ...
    const table = useReactTable({
        data: wishers as unknown as Data[],
        columns,
        state: {
            sorting,
            columnFilters,
