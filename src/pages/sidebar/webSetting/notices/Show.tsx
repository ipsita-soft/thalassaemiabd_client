...
const Show: React.FC<EditSliderProps> = ({ Id }) => {
  ...
  const sliderToShow = events.find((events) => events.id.toString() === Id) as Events | undefined;
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        ...
        <div className="grid gap-4">
          ...
          <div className="grid gap-2">
            <Label htmlFor="description" className="font-medium text-gray-700">Date</Label>
            {sliderToShow.date}
          </div>
          ...
          <div className=' grid grid-cols-2'>
            ...
            <div className="">
              ...
              <span className=" text-gray-800">: {sliderToShow.sorting_index}</span>
            </div>
